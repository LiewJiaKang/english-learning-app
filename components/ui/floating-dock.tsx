  ...
  return (
    <div className={cn("relative block md:hidden", className)}>
      ...
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full bg-secondary border border-border"
      >
...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden h-16 items-end gap-4 rounded-2xl px-4 pb-3 md:flex bg-background/65 backdrop-blur-md border border-border",
        className,
      )}
    >
      {items.map((item) => (
